...
class AirticketDetailview extends StatefulWidget {
     final AirTicketData ticketData;
  const AirticketDetailview({super.key, required this.ticketData});

  @override
  State<AirticketDetailview> createState() => _AirticketDetailviewState();
}

class _AirticketDetailviewState extends State<AirticketDetailview> {
  bool loading = false;
  ...
  void initState() {
    super.initState();
    //getdetailsdata();
     filteredList = [widget.ticketData];
  }
